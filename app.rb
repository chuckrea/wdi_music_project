...
post '/' do
  ...
  artist_1_url  = "http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&mbid=#{@artist_id}&api_key=#{lastfm_key}&format=json"
  @artist_1 = HTTParty.get(artist_1_url)

  artist_1_top_tracks_url  = "http://ws.audioscrobbler.com/2.0/?method=artist.gettoptracks&mbid=#{@artist_id}&api_key=#{lastfm_key}&format=json"
  @artist_1_top_tracks  = HTTParty.get(artist_1_top_tracks_url)

  artist_1_albums_url  = "http://ws.audioscrobbler.com/2.0/?method=artist.gettopalbums&mbid=#{@artist_id}&api_key=#{lastfm_key}&format=json"
  ...
  events_url = "http://ws.audioscrobbler.com/2.0/?method=artist.getevents&mbid=#{@artist_id}&api_key=#{lastfm_key}&format=json"
